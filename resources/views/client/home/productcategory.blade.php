...
<div class="breadcrumbs">
    <div class="container">
        <div class="row">
            <div class="col">
                <p class="bread"><span><a href="/">Home</a></span> / <span>Produk</span> / <span>{{$kategori->nama_kategori}}</span></p>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="product-entry border">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <strong>Harga :</strong> @currency($p->harga)<br>
                                <strong>Stok :</strong> {{$p->stok}}
                            </p>
                            <a href="/customer/detail/view/{{$p->id}}" class="btn btn-outline-primary"> Detail</a>
                        </div>
                    </div>
                </div>
            </div>
