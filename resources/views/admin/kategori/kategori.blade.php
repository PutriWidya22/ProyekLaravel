            ...
            <div class="card top-selling overflow-auto">
              ...
              <div class="card-body pb-0">
                ...
                <div class="card-header">
                  <center>DATA KATEGORI<br>
                  </div>
                  <div class="card-header">
                  <a href="/admin/kategori/add"><button class="btn btn-sm btn-primary float-right">TAMBAH</button></a>
                </div>
                ...
                <table id="myTable" class="table table-borderless">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="/admin/kategori/edit/{{$d->id}}"><button type="button" class="btn btn-warning btn-sm">Edit</button></a>
                        <a href="/admin/kategori/destroy/{{$d->id}}"><button type="button" class="btn btn-danger btn-sm">Delete</button></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
