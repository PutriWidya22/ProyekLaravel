  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-9">
        ...
        <div class="card">
          <div class="card-body">
            <form role="form" action="{{url('/admin/produk/create')}}" method="post" enctype="multipart/form-data">
              @csrf
              <h5 class="card-title">Tambah Produk</h5>

                <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-5 col-form-label">Nama Sepatu</label>
                ...
                <div class="row mb-3">
                  <label for="inputKategori" class="col-sm-2 col-form-label">Warna</label>
                ...
                <div class="row mb-3">
                  <label for="inputKategori" class="col-sm-2 col-form-label">Ukuran</label>
                ...
                <div class="row mb-3">
                  ...
                  <input type="varchar" class="form-control" name="harga">
                </div>
