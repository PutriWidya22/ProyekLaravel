    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-9">
          ...
          <div class="card">
            <div class="card-body">
                <form role="form" action="{{url('/admin/color/update/'. $data->id)}}" method="post" enctype="multipart/form-data">
                    @csrf  
              <h5 class="card-title">Edit Warna</h5>
              ...
              <form>
                ...
                <div class="row mb-3">
                    <label for="inputNama" class="col-sm-5 col-form-label">Warna</label>
