      ...
      <nav>
        <ol class="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/admin/size">Ukuran</a></li>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-9">
          ...
          <div class="card">
            <div class="card-body">
                <form role="form" action="{{url('/admin/size/update/'. $data->id)}}" method="post" enctype="multipart/form-data">
                    @csrf  
              ...
              <form>
                ...
                <div class="row mb-3">
                    <label for="inputNama" class="col-sm-5 col-form-label">Ukuran</label>
